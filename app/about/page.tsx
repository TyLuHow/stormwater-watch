...
// ABOUT PAGE - Moved from landing page per domain expert feedback
// Water professionals need violations first, not marketing content
// This page preserves mission/features for users who want background
              ...
              <CardContent>
                <div className="space-y-4">
                  {[
                    ...
                    {
                      source: "CalEnviroScreen 4.0 (DAC Boundaries)",
                      description: "Disadvantaged Community (DAC) designations, pollution burden scores",
                      update: "Geodata download needed",
                      status: "⚙ Infrastructure Ready",
                      statusColor: "text-orange-600",
                    },
                    {
                      source: "USGS Watershed Boundary Dataset (HUC12)",
                      description: "Watershed polygons for spatial context and water quality tracking",
                      update: "Geodata download needed",
                      status: "⚙ Infrastructure Ready",
                      statusColor: "text-orange-600",
                    },
      ...
      <footer className="border-t bg-muted/30">
        <div className="container mx-auto px-6 py-12">
          ...
          <div className="border-t mt-8 pt-8 text-center text-sm text-muted-foreground">
            <p>
              Built with care for environmental advocates, by environmental advocates.
            </p>
            <p className="mt-2">
